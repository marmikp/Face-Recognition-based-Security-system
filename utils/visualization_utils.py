  ...
  for box, color in box_to_color_map.items():
    ...
    if keypoints is not None:
      draw_keypoints_on_image_array(
          ...
          use_normalized_coordinates=use_normalized_coordinates)
    #name = find_between(str(box_to_display_str_map[box]),"'",":")
    #print(find_between(str(box_to_display_str_map[box]),":","%"))

    if find_between(str(box_to_display_str_map[box]),"'",":") =="person" and int(find_between(str(box_to_display_str_map[box]),":","%")) > 50:
      c = 1
